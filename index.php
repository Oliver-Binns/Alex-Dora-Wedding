		...
		<?php
			...
			echo new UIDiv([
				...
				new UISection([
                            ...
                            new UIDiv([
                                new UIDiv([
                                    'Volos is located 327km from Athens and 208km from Thessaloniki. The E75 national motorway passes close by and the city centre can be reached by taking the exit onto the E92 motorway. The motorways are well signposted, but please note there are a number of toll stations so keep plenty of loose change! Cars can be hired from Athens and Thessaloniki airports.'
                                ], 'col-xs-12'),
                                new UIDiv([
                                    new UITextBox('', '', 'Enter a location..', '', false, 'form-control', 'car-input')
                                ], 'col-xs-12')
                            ], ['travel_option', 'travel_car row']),
